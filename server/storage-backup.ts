...
export class MemStorage implements IStorage {
  ...
  constructor() {
    ...
    this.brands = new Map();
    this.currentMaterialId = 1; // Start fresh
  ...
  async getMaterials(filters?: {
      ...
      // Additional Hardwood
      {
        ...
        specifications: {
          'Product Name': 'Maple Select Solid Hardwood',
          'Brand/Manufacturer': 'Bruce',
          'Species': 'Hard Maple (Acer saccharum)',
          'Grade': 'Select & Better',
          'Construction Type': 'Solid Wood',
          'Finish': 'Pre-Finished Polyurethane',
          'Width': '2.25"',
          ...
          'Moisture Content': '6-8%',
          'Gloss Level': 'Semi-Gloss (25-35 sheen)',
          'Warranty': '25-year residential finish warranty',
          'Country of Origin': 'USA',
          'CARB Compliance': 'CARB2 Compliant',
          'Applications': 'Residential, Commercial',
          'Product URL': 'https://www.bruce.com/hardwood-flooring/maple-select'
        },
      ...
      },
      {
        ...
        specifications: {
          'Product Name': 'Hickory Engineered Hardwood',
          'Brand/Manufacturer': 'Shaw',
          'Species': 'Hickory (Carya ovata)',
          'Grade': 'Character Grade',
          'Construction Type': 'Engineered (5-Ply)',
          'Finish': 'Pre-Finished UV Polyurethane',
          'Width': '5"',
          'Thickness': '1/2"',
          'Length': 'Random Length 12" - 48"',
          'Material Type': 'Engineered Hardwood',
          'Wear Layer': '2mm Hardwood Veneer',
          'Edge Profile': 'Micro-Beveled',
          'Installation Method': 'Floating, Nail Down, Glue Down',
          'Janka Hardness': '1,820 lbf',
          'Moisture Content': '6-9%',
          'Gloss Level': 'Low Gloss (10-25 sheen)',
          'Warranty': '50-year residential warranty',
          'Country of Origin': 'USA',
          'CARB Compliance': 'CARB2 Compliant',
          'Applications': 'Residential, Commercial',
          'Product URL': 'https://www.shawfloors.com/flooring/hardwood/hickory-engineered'
        },
        dimensions: "1/2\"x5\"",
        inStock: true,
      },
